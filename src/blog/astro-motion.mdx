...
<br />
Here is all the JavaScript I added to the starter code to start seeing the
animations:
<br />
...
<br />
Update: If you prefer to not use JavaScript for your animations as Astro is
intentionally designed to minimize the amount of JavaScript you use, Motion now
has expanded into CSS animations
<a
  className="underline"
  href="https://motion.dev/docs/css#astro"
  target="_blank"
>
...
<br />
Here is the full `Welcome.astro` component, containing all the html, CSS and
JavaScript with the animations on nearly every element.
<br />
