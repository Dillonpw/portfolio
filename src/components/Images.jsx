const images = [
...

  {
    ...
    description:
      'This template is part of The Odin Project React curriculum, built with React and TypeScript. You will notce a checkout area if you decide to go through te motions of the website, it does not submit anything it, it clears the cart. Engaging in this project introduced me to many new concepts within React. I dove headfirst into the useContext hook and scoured the React documentation to gain what I believe is a working grasp of its uses. In the end, I am happy with the outcome. The goal was to create something purposely generic and minimal, and I believe that’s what I have achieved.',
  },
