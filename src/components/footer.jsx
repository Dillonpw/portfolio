...
export default function Footer() {
  return (
    <>
      <div
        id="connect"
        className="ml-3 flex flex-col items-start justify-center"
      >
        <p>
          Feel free to reach out! <br></br>
          <p className="">
            <FontAwesomeIcon icon={faEnvelope} /> Dillonpwalsh10@gmail.com
          </p>
        </p>
        <p>
          More Info{" "}
          <a
            ...
            rel="noreferrer"
          >
            <FontAwesomeIcon className="mr-2 hover:scale-110" icon={faGithub} />
          </a>
          <a
            id="linkedin-link"
